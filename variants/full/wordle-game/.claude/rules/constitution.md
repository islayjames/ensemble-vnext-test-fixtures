# Wordle CLI Constitution

Project absolutes and architecture invariants for a command-line Wordle game in Python.
...
Python CLI application using standard library only
...
- pytest (development dependency for testing)
...
- New dependencies (story.md specifies standard library only)
...
6. **No external dependencies** - Standard library only per project requirements
