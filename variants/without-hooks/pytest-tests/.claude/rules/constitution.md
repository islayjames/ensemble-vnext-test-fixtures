# string-utils Constitution

Project absolutes and architecture invariants for Python string utility module with comprehensive pytest tests.
...
Python utility module with comprehensive test coverage using pytest.
...
- [ ] Tests pass (unit >= 90%, integration >= 70% when applicable)
- [ ] No secrets in code
